                                        ...
                                        <div class="table-responsive">
                                            <table class="table" id='myTable'>
                                                <thead>
                                                    <tr>
                                                        <th>#</th>
                                                        <th>{!! __('employees.employee_status_name') !!}</th>
                                                ...
                                                <tbody>
                                                    @forelse ($employeeStatuses as $status)
                                                        <tr>
                                                    ...
                                                    @empty
                                                        <tr>
                                                            <td colspan="5" class="text-center">
                                                                {!! __('employees.no_employee_statuses_found') !!}
                                                            </td>
                                                        </tr>
                                                    @endforelse
                                                </tbody>
...
@push('scripts')
    <script type="text/javascript">
        // delete
        $('body').on('click', '.delete_employee_status_btn', function(e) {
            e.preventDefault();
            var id = $(this).data('id');
            ...
            swal({
                ...
                if (isConfirm) {
                    $.ajax({
                        url: '{!! route('dashboard.employee.statues.destroy') !!}',
                        data: {
                            id,
                            id
                        },
