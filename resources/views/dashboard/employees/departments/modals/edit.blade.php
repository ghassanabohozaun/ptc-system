<div class="modal modal-pop fade" id="updateDepartmentModal" tabindex="-1" role="dialog" aria-labelledby="updateDepartmentModalLabel"
    aria-hidden="true">
        ...
        <form class="form" action="" method="POST" enctype="multipart/form-data" id='update_department_form'>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer border-0 pt-0">
                    ...
                    <button type="button" id="cancel_department_btn_edit" class="btn btn-light-dark font-weight-bold h-42 radius-10"
                        data-dismiss="modal">
