                    ...
                    <div class="content-body">
                        ...
                        <section id="basic-form-layouts">
                            <div class="row match-height">
                                <div class="col-md-12">
                                    {{-- @include('dashboard.dailyReports.partials._search') --}}
                                    @include('dashboard.daily-reports.partials._table')
                                </div><!-- end: row  -->
    ...
    <script type="text/javascript">
        ...
        function loadData(created_at = '') {
            ...
            $('#yajra-datatable').DataTable({
                ...
                ajax: {
                    url: '{!! route('dashboard.daliy.reports.get.all') !!}',
                    data: {
        ...
        $('body').on('click', '#dailyReportDetailModal', function(e) {
            ...
            $('.details_summernote2').summernote('code', details);
            $('.details_summernote2').summernote('disable');
