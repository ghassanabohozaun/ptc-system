                ...
                <table class="table" id="myTable">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center">{!! __('salaries.salaries_count') !!}</th>
                            <th class="text-center">{!! __('salaries.salaries_sum') !!}</th>
                    ...
                    <tbody>
                        @forelse ($salaries as $salary)
                            <tr id="row{{ $salary->id }}">
                                    ...
                                    <div class="row-details d-none">
                                        <div class="modal-details-card">
                                            ...
                                            <div class="text-center">
                                                ...
                                                <h4 class="modal-name-title">{{ __('salaries.' . $salary->month) }} /
                                                    {{ $salary->year }}
                                                </h4>
                                                <span
                                ...
                                <td class="text-center d-none d-lg-table-cell text-muted small">{{ $loop->iteration }}
                                </td>
                                ...
                                <td class="text-center">
                                    <div class="badge badge-pill badge-info px-2">
