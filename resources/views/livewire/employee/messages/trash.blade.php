        ...
        <div class="card-body">
            <div class="d-sm-flex justify-content-between align-items-center msg-card-header-premium">
                <div>
                    <h4 class="text-dark fw-bold mb-0">
                        <i class="mdi mdi-delete-outline me-2 text-danger" style="font-size: 1.5rem"></i>
                        {!! __('messages.trash') !!}
                    </h4>
                </div>
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle">
                    <thead>
                        <tr class="bg-light">
                            <th style="width: 200px;" class="border-0 px-3">{!! __('messages.user') !!}</th>
                            <th class="border-0">{!! __('messages.subject') !!}</th>
                            <th style="width: 150px;" class="border-0">{!! __('messages.date') !!}</th>
                            <th style="width: 180px;" class="border-0 text-end px-3">{!! __('messages.actions') !!}</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="4" class="text-center py-5">
                                    <div class="py-5">
                                        <i class="mdi mdi-delete text-muted opacity-50" style="font-size: 10rem;"></i>
                                        <p class="mt-4 text-muted fw-bold fs-4">{!! __('messages.no_trash_messages') !!}</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
