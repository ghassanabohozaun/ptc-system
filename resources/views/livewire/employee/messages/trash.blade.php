    ...
    <div class="card card-rounded">
        <div class="card-body">
            <div class="d-sm-flex justify-content-between align-items-start mb-4">
                <div>
                    <h4 class="card-title card-title-dash"><i class="mdi mdi-delete-variant  me-2 text-danger"
                            ...
                            <tr wire:key="msg-{{ $message->id }}">
                                ...
                                <td class="text-end">
                                    <button wire:click="restore({{ $message->id }})"
                                        class="btn btn-outline-success btn-fw text-dark"
                                        title="{!! __('messages.restore') !!}">
                                        <i class="mdi mdi-restore"></i>
                                    </button>
                                    <button wire:click="confirmPermanentDelete({{ $message->id }})"
                                        class="btn btn-outline-danger btn-fw text-dark" title="{!! __('messages.delete_forever') !!}">
                        ...
                        @empty
                            <tr>
                                <td colspan="4" class="text-center py-5 text-muted">
                                    <i class="mdi mdi-delete-outline fa-3x mb-3 opacity-25"></i>
