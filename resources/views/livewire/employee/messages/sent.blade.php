            ...
            <div class="d-sm-flex justify-content-between align-items-center msg-card-header-premium">
                <div>
                    <h4 class="text-dark fw-bold mb-0">
                        <i class="mdi mdi-send-outline me-2 text-primary" style="font-size: 1.5rem"></i>
                        {!! __('messages.sent') !!}
                    </h4>
                </div>
                ...
                <table class="table table-hover align-middle">
                    <thead>
                        <tr class="bg-light">
                            ...
                            <th style="width: 200px;" class="border-0">{!! __('messages.to') !!}</th>
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="text-center py-5">
                                    <div class="py-5">
                                        <i class="mdi mdi-send text-muted opacity-50" style="font-size: 10rem;"></i>
                                        <p class="mt-4 text-muted fw-bold fs-4">{!! __('messages.no_sent_messages') !!}</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h6 class="mb-0 fw-bold text-dark fs-6">
                                        To: {{ $selectedMessage->receiver->name ?? 'Unknown' }}
                                    </h6>
                                    <small class="text-muted fw-semibold">{{ $selectedMessage->receiver->email ?? '' }}</small>
                                </div>
                            </div>
