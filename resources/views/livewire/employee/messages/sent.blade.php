            ...
            <div class="d-sm-flex justify-content-between align-items-start mb-4">
                <div>
                    <h4 class="card-title card-title-dash">
                        <i class="mdi mdi-send me-2 text-primary" style="font-size: 18px"></i> {!! __('messages.sent') !!}
                    </h4>
                </div>
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="text-center py-5 text-muted">
                                    <i class="mdi mdi-send fa-3x mb-3 opacity-25"></i>
                    ...
                    @if ($selectedMessage)
                        <div class="d-flex justify-content-between align-items-center mb-4 border-bottom pb-3">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h6 class="mb-0 fw-bold text-dark">To:
                                        {{ $selectedMessage->receiver->name ?? 'Unknown' }}</h6>
                                    <small class="text-muted">{{ $selectedMessage->receiver->email ?? '' }}</small>
                                </div>
                            </div>
                            <div class="text-end">
                                <small
