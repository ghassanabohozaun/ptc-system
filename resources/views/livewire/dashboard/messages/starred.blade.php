                ...
                <table class="table table-hover mb-0">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center col-w-45"><i class="la la-star text-warning"></i></th>
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="text-center py-5">
                                    <div class="py-5">
                                        <i class="la la-star-o text-muted opacity-25" style="font-size: 5rem;"></i>
