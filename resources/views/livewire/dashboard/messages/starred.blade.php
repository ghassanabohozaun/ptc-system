        ...
        <div class="msg-card-header-premium d-flex justify-content-between align-items-center">
            <div>
                <h4 class="text-dark font-weight-bold mb-0">
                    <i class="ft-star mr-2 text-warning"></i>
                    {!! __('messages.starred') !!}
                </h4>
            </div>
                ...
                <table class="table table-hover mb-0">
                    <thead>
                        <tr class="bg-light">
                            ...
                            <th class="border-0 text-center col-w-200">{!! __('messages.user') !!}</th>
                        ...
                        @empty
                            <tr>
                                <td colspan="4" class="text-center py-5">
                                    <div class="py-5">
                                        <i class="ft-star text-muted opacity-25 empty-state-icon-lg"></i>
                                        <p class="mt-4 text-muted font-weight-bold h5">{!! __('messages.no_starred_messages') !!}</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
